...
const fetchAllData = async () => {
    ...
    try {
        await Promise.all([fetchGeneralStats(), fetchDailyStats(), fetchMonthlyStats(), fetchProducts(), fetchMixes(), fetchRecentSales()]);
    } catch (err) {
    ...
    <div>
        ...
        <div class="mb-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <div class="relative">
                        <input type="month" v-model="endDate" @change="fetchAllData" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                    </div>
                    <button @click="fetchAllData" :disabled="loading" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
        ...
        <div v-else class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Today's Stats -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-6">Oylik ko'rsatkichlar</h3>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                            <div>
                                <p class="text-sm text-gray-600">Oylik sotuv</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <div>
                                <p class="text-sm text-gray-600">Oylik foyda</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                            <div>
                                <p class="text-sm text-gray-600">Oylik buyurtmalar</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full"> {{ recentProductSales.length }} ta </span>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="sale in recentProductSales" :key="sale._id" class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full"> {{ sale.size }} kg </span>
                                    </td>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span class="px-2 py-1 bg-orange-100 text-orange-800 text-xs font-medium rounded-full"> {{ recentMixSales.length }} ta </span>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                ...
                                <tr v-for="sale in recentMixSales" :key="sale._id" class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm font-medium text-gray-900">{{ sale.fullName }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 bg-orange-100 text-orange-800 text-xs font-medium rounded-full"> {{ sale.size }} kg </span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm font-bold text-green-600">
                                        {{ formatCurrency(sale.totalPrice) }}
                                    </td>
